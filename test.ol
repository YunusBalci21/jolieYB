...
service main {
    ...
    main {
        ...
        add@date( { date = { year = 2023, month = 10, day = 5 },
                    addYears = 1, addMonths = 2, addDays = 15 } )( addResponse );
        ...
        sub@date( { date = { year = 2023, month = 10, day = 5 },
                    addYears = 1, addMonths = 2, addDays = 15 } )( subResponse );
        ...
        compare@date( { date = { year = 2023, month = 10, day = 5 },
                        addDate = { year = 2023, month = 12, day = 25 } } )( compResponse );
        if ( compResponse == -1 ) {
